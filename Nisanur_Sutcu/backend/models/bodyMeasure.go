...
type BodyMeasure struct {
	...
	Arm      float64            `json:"arm" bson:"arm"`
	Waist    float64            `json:"waist" bson:"waist"`
	Neck     float64            `json:"neck" bson:"neck"`
	Leg      float64            `json:"leg" bson:"leg"`
	Hip      float64            `json:"hip" bson:"hip"`
	Shoulder float64            `json:"shoulder" bson:"shoulder"`
