...
export default function RegisterScreen({ navigation }) {
    // Backend'in senden beklediği muhtemel veriler
    ...
    const handleRegister = async () => {
        ...
        try {
            // Backend'deki kayıt ol rotasına gidiyoruz
            const response = await axios.post('https://gym-hku6.onrender.com/auth/register', {
                name: name.trim(),
                email: email.trim(),
                password: password
            });
